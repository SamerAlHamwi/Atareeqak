...
import { AlignLeft, FileText, Send, AlertOctagon, AlertTriangle, CheckCircle2 } from 'lucide-react';
      ...
      >
        ...
        <div className="p-6 space-y-6">
          {complaint.isAutoGenerated && (
            <div
              data-testid="complaint-auto-generated-badge"
              className="flex items-center gap-2 bg-error-container text-on-error-container text-xs font-bold px-4 py-3 rounded-lg"
            >
              <AlertTriangle size={16} className="shrink-0" />
              {t('support.auto_generated_badge')}
            </div>
          )}

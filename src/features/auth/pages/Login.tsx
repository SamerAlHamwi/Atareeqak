          ...
          <div>
            ...
            <div className="relative group">
              <input
                type="text"
                required
                className="w-full bg-surface-container-low border border-outline-variant rounded-2xl ltr:pl-14 ltr:pr-6 rtl:pr-14 rtl:pl-6 py-4 outline-none focus:ring-2 focus:ring-primary/20 transition-all"
          ...
          <div>
            ...
            <div className="relative group">
              <input
                ...
                required
                className="w-full bg-surface-container-low border border-outline-variant rounded-2xl ltr:pl-14 ltr:pr-14 rtl:pr-14 rtl:pl-14 py-4 outline-none focus:ring-2 focus:ring-primary/20 transition-all"
